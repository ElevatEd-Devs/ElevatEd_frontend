...
const CourseDetailPage = () => {
  ...
  const upcomingEvents = [
    { id: 'event1', title: 'Midterm Exam - Calculus I', date: 'July 20', time: '10:00 AM', course: 'Calculus I' },
    { id: 'event2', title: 'Homework Due - History of Art', date: 'July 21', time: '5:00 PM', course: 'History of Art' },
    { id: 'event3', title: 'Project Presentation - Introduction to Psychology', date: 'July 22', time: '1:00 PM', course: 'Introduction to Psychology' }
  ];
